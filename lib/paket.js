...
PaketService__exec$ = (function(location,cmd,handler)
{
    ...
    {
      _288 = (child_process.exec(((location + " ") + cmd), options, handler));
    }
    else
    {
      _288 = (child_process.exec(((("mono " + location) + " ") + cmd), options, handler));
    };
    var child = _288;
});
...
PaketService__notice$ = (function(isError,text,details)
{
    if ((PaketService__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _601 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _601 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _601;
...
PaketService__spawn$ = (function(location,cmd)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _416 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _416 = (child_process.spawn("mono", prms, options));
    };
    var procs = _416;
