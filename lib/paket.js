...
PackageView__regiterListView$ = (function(stopChangingCallback,cancelledCallback,confirmedCallback,removeFiler)
{
    ...
    return {Tag: 1.000000, Value: (new TupleSelectListView__IPanel_(listView, panel))};
});
...
PaketService__exec$ = (function(location,cmd,handler)
{
    ...
    {
      _290 = (child_process.exec(((location + " ") + cmd), options, handler));
    }
    else
    {
      _290 = (child_process.exec(((("mono " + location) + " ") + cmd), options, handler));
    };
    var child = _290;
});
...
PaketService__notice$ = (function(isError,text,details)
{
    if ((PaketService__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _603 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _603 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _603;
...
PaketService__spawn$ = (function(location,cmd)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _418 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _418 = (child_process.spawn("mono", prms, options));
    };
    var procs = _418;
...
{
    PackageView__packagesListView = PackageView__registerPackagesListView$();
    PackageView__versionsListView = PackageView__registerVersionListView$();
