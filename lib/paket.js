...
PackageView__get_removeProject$ = (function()
{
    return false;
});
...
{
    var ignored0 = (lv.setItems(Array__Map$String_1_Object_String_Object_((function(n)
    {
    ...
    var confirmedCallback = (function(packageDescription)
    {
      ...
      if (PackageView__settings.Versioned) 
      {
        return Option__Iterate$Tuple_2_SelectListView__IPanel_Tuple_2_SelectListView__IPanel_((function(tupledArg)
        {
          ...
          var cmd = (("find-package-versions name " + PackageView__name) + " -s");
          return PaketService__execPaket$(cmd, (function(delegateArg,_delegateArg,__delegateArg)
          {
            return (function(error)
            {
...
PackageView__registerRemoveListView$ = (function(unitVar0)
{
    ...
    var confirmedCallback = (function(packageDescription)
    {
      PackageView__name = String__SplitWithoutOptions$(packageDescription.data, [" "])[0].trim();
      Option__Iterate$Tuple_2_SelectListView__IPanel_Tuple_2_SelectListView__IPanel_((function(tupledArg)
      {
        var model = tupledArg.Items[0.000000];
        var view = tupledArg.Items[1.000000];
...
PaketService__Remove$ = (function(project,unitVar1)
{
    PackageView__removeProject = project;
    return Option__Iterate$Tuple_2_SelectListView__IPanel_Tuple_2_SelectListView__IPanel_((function(tupledArg)
    {
      var model = tupledArg.Items[0.000000];
      var view = tupledArg.Items[1.000000];
      ...
      if ((!project)) 
      {
        _917 = "show-installed-packages -s";
      }
      else
      {
        var path = ((((((window.atom).workspace).getActiveTextEditor()).buffer).file).path);
        var projectStr = ((" project \"" + path) + "\"");
        _917 = (("show-installed-packages" + projectStr) + " -s");
      };
      var cmd = _917;
...
{
    return PaketService__spawn$(PaketService__bootstrapperLocation, "-s");
});
PaketService__exec$ = (function(location,cmd,handler)
{
    ...
    {
      _295 = (child_process.exec(((location + " ") + cmd), options, handler));
    }
    else
    {
      _295 = (child_process.exec(((("mono " + location) + " ") + cmd), options, handler));
    };
    var child = _295;
});
...
PaketService__jq__$ = (function(context,selector)
{
...
PaketService__notice$ = (function(isError,text,details)
{
    if ((PaketService__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _610 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _610 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _610;
    ...
    else
    {
      ...
      var t = PaketService__jq__$(view, ".content .detail .detail-content");
...
PaketService__spawn$ = (function(location,cmd)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _425 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _425 = (child_process.spawn("mono", prms, options));
    };
    var procs = _425;
...
PackageView__removeProject = PackageView__get_removeProject$();
