...
PaketService__exec$ = (function(location,cmd,handler)
{
    ...
    {
      _292 = (child_process.exec(((location + " ") + cmd), options, handler));
    }
    else
    {
      _292 = (child_process.exec(((("mono " + location) + " ") + cmd), options, handler));
    };
    var child = _292;
});
...
PaketService__notice$ = (function(isError,text,details)
{
    if ((PaketService__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _607 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _607 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _607;
...
PaketService__spawn$ = (function(location,cmd)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _422 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _422 = (child_process.spawn("mono", prms, options));
    };
    var procs = _422;
